...
- Das Feld Kontoinhaber wurde für SEPA-Lastschrift, SEPA-Lastschrift mit Zahlungsgarantie und Ratenzahlung per SEPA-Lastschrift gemäß den Anforderungen der Verification of Payee (VoP)-Richtlinie implementiert
- Der EPC/SPC QR-Code wurde für die Zahlungsarten Vorauszahlung, Rechnung, Rechnung mit Zahlungsgarantie und Ratenzahlung per Rechnung implementiert

### Behoben

- Die Verarbeitung der Post-Data-URLs für Domains mit oder ohne abschließenden Schrägstrich wurde verbessert

### Verbessert

- Das iDEAL-Zahlungslogo sowie der Zahlungstitel wurden in iDEAL | Wero geändert
- Die Callback-/Webhook-Logik wurde für eine effizientere Verarbeitung dynamischer IP-Adressen optimiert
- Die Verarbeitung von Telefonnummern und Unternehmensdaten in Zahlungsanfragen wurde optimiert
- Die Konfiguration zulässiger Länder und Bestellbetragsgrenzen wurde für alle Zahlungsmethoden erweitert
- Die Benutzeroberfläche für den Workflow zur Ereigniserstellung wurde überarbeitet

### Entfernt

- Die Zahlungsmethoden Sofort, giropay, Barzahlen/viacash und Payconiq wurden entfernt

## v12.2.0 (2025-03-27)

### Neu

- TWINT-Zahlung implementiert

### Behoben

- Google Pay Button wird korrekt angezeigt, wenn andere Zahlungsanbieter aktiv sind
- Novalnet-Transaktionsdetails werden beim Erstellen einer Rechnung mit Document Builder aktualisiert

### Verbessert

- Erweiterung der Ratenzahlungszyklen auf 36 Zyklen
- Angebot von Ratenzahlungen und Garantiezahlungen für B2B-Kunden in der Schweiz
- E-Mail-Benachrichtigung für erfolgreiche Transaktionen an den Shop Besitzer für fehlende Bestellungen
- Integrierte Sub-Resource-Integrität (SRI) für JavaScript-Dateien zur Verbesserung der Sicherheit, um unbefugte Änderungen zu verhindern
- Verkleinerung von JavaScript-Dateien für verbesserte Leistung
- Optimierung des Callback/Webhook-Prozesses zum Abrufen der dynamischen IP
- Das Novalnet-Zahlungsplugin wurde für neue Testfälle optimiert
...
- Implementiert Ratenzahlung per SEPA-Lastschrift, Ratenzahlung per Rechnung, Lastschrift ACH, MBway, Blik und Payconiq
- Auftragserstellung über die Shop-Verwaltung

### Entfernt

- Fälligkeitsdatum konfiguration für Lastschrift SEPA mit Zahlungsgarantie
