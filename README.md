...
1.	To get the payment plugin for the plentymarkets shop, follow the plugin installation steps provided in the <a href="https://www.novalnet.de/site_pdf/plentymarkets/Installation_guide.pdf"> Installtion Guide </a>
